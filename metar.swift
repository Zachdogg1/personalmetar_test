...
class station {
    ...
    init(index: Int){
        print("start")
        id = stationID[1][43 + (42*index)]
        time  = stationID[1][43 + 1 + (42*index)]
        lat = stationID[1][43 + 2 + (42*index)]
        long = stationID[1][43 + 3 + (42*index)]
        temp = stationID[1][43 + 4 + (42*index)]
        dewpoint = stationID[1][43 + 5 + (42*index)]
        wind_d = stationID[1][43 + 6 + (42*index)]
        wind_s = stationID[1][43 + 7 + (42*index)]
        wind_g = stationID[1][43 + 8 + (42*index)]
        visibility = stationID[1][43 + 9 + (42*index)]
        alt = stationID[1][43 + 10 + (42*index)]
        sea = stationID[1][43 + 11 + (42*index)]
        corrected = stationID[1][43 + 12 + (42*index)]
        auto = stationID[1][43 + 13 + (42*index)]
        auto_s = stationID[1][43 + 14 + (42*index)]
        main = stationID[1][43 + 15 + (42*index)]
        no_s = stationID[1][43 + 16 + (42*index)]
        light = stationID[1][43 + 17 + (42*index)]
        freeze = stationID[1][43 + 18 + (42*index)]
        present = stationID[1][43 + 19 + (42*index)]
        wx_s = stationID[1][43 + 20 + (42*index)]
        sky_cover = stationID[1][43 + 21 + (42*index)]
        cloud_b = stationID[1][43 + 22 + (42*index)]
        sky_cover2 = stationID[1][43 + 23 + (42*index)]
        cloud_b2 = stationID[1][43 + 24 + (42*index)]
        sky_cover3 = stationID[1][43 + 25 + (42*index)]
        cloud_b3 = stationID[1][43 + 26 + (42*index)]
        sky_cover4 = stationID[1][43 + 27 + (42*index)]
        cloud_b4 = stationID[1][43 + 28 + (42*index)]
        flight = stationID[1][43 + 29 + (42*index)]
        three_hr = stationID[1][43 + 30 + (42*index)]
        maxT = stationID[1][43 + 31 + (42*index)]
        minT = stationID[1][43 + 32 + (42*index)]
        maxT24 = stationID[1][43 + 33 + (42*index)]
        minT24 = stationID[1][43 + 34 + (42*index)]
        precip = stationID[1][43 + 35 + (42*index)]
        pcp3 = stationID[1][43 + 36 + (42*index)]
        pcp6 = stationID[1][43 + 37 + (42*index)]
        pcp24 = stationID[1][43 + 38 + (42*index)]
        snowin = stationID[1][43 + 39 + (42*index)]
        vert = stationID[1][43 + 40 + (42*index)]
        metar_type = stationID[1][43 + 41 + (42*index)]
        elevation_m = stationID[1][43 + 42 + (42*index)]
        print("end")
